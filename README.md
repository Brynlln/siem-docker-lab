...
## Overview
This project simulates a lightweight SIEM (Security Information and Event Management) system using Docker.
...
```
## Key Outcome
Successfully simulated and detected brute-force login attempts using log analysis and conditional alerting inside a Docker container.
...
## Resume Bullet
- Built a lightweight SIEM lab using Docker to simulate brute-force login attempts, analyze authentication logs, and trigger alerts using Bash-based detection logic.
